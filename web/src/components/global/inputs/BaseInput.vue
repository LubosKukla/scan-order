  ...
  <div class="space-y-2 p-2">
    ...
    <div class="relative">
      ...
      <div
        ...
        type="button"
        class="absolute inset-y-0 cursor-pointer right-2 flex items-center justify-center rounded-full p-2 text-deep/60 transition hover:text-deep focus:outline-none focus-visible:ring-1 focus-visible:ring-primary/10"
